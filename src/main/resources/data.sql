...
(1, 'admin@app.local',        '$2a$12$x5rVmtYBheXLyBm8ifmu4eP8fMfVY8WKT6UY8kSlX60ypyA1ykuiq',  TRUE,  TRUE,  NOW(), DATE_ADD(NOW(), INTERVAL 3 MONTH), 0, TRUE,  FALSE),
(2, 'jdoe@app.local',         '$2a$12$x5rVmtYBheXLyBm8ifmu4eP8fMfVY8WKT6UY8kSlX60ypyA1ykuiq',      TRUE,  TRUE,  NOW(), DATE_ADD(NOW(), INTERVAL 3 MONTH), 1, FALSE, FALSE),
(3, 'maria@app.local',        '$2a$12$x5rVmtYBheXLyBm8ifmu4eP8fMfVY8WKT6UY8kSlX60ypyA1ykuiq',  TRUE,  TRUE,  NOW(), DATE_ADD(NOW(), INTERVAL 3 MONTH), 0, TRUE,  TRUE ),
(4, 'blockeduser@app.local',  '$2a$12$x5rVmtYBheXLyBm8ifmu4eP8fMfVY8WKT6UY8kSlX60ypyA1ykuiq',    FALSE, FALSE, NOW(), DATE_ADD(NOW(), INTERVAL 3 MONTH), 5, FALSE, FALSE);
