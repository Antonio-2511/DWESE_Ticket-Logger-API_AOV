...
import org.iesalixar.daw2.aov.dwese2526_ticket_logger_api_aov.dtos.ApiErrorDTO;
...
public class ApiExceptionHandler {
    ...
    public ResponseEntity<ApiErrorDTO> handleInvalidFile(InvalidFileException ex,
                                                         HttpServletRequest req) {
    ...
    public ResponseEntity<ApiErrorDTO> handleBadJson(HttpMessageNotReadableException ex,
                                                     HttpServletRequest req) {
    ...
    /**
     * Fallo genérico de autenticación -> 401 Unauthorized.
     */
