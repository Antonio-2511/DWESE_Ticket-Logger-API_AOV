...
public class ResourceNotFoundException extends RuntimeException {
    ...
    /**
     * Campo utilizado en la búsqueda que ha provocado el "no encontrado"
     * (por ejemplo: "id", "code", "email").
     */
    private final String field;

    /**
     * Valor concreto del campo con el que se intentó localizar el recurso
     * (por ejemplo: 5, "AND", "a@b.com").
     */
    private final Object value;

    /**
     * Construye una excepción indicando el recurso y el criterio de búsqueda
     * que no ha devuelto resultados.
     *
     * @param resource nombre del recurso/entidad (ej. {@code "region"}).
     * @param field nombre del campo usado como criterio de búsqueda
     *              (ej. {@code "id"}).
     * @param value valor del campo usado en la búsqueda
     *              (ej. {@code 5}).
     */
    ...
    // ===== Getters requeridos por ApiExceptionHandler =====
